...
namespace Quiz10
{
    public partial class HemsireEkle : Form
    {
        ...
        private void btn_kaydol_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand com = new SqlCommand("insert into personel(tc,parola,ad,soyad,bolumId,hemsireId,unvanId,randevuId) values(@tc,@parola,@ad,@soyad,@bolumId,'2',@randevuId)", con);
            try
            {
                ...
                if (con.State == ConnectionState.Closed)
                {
                    ...
                    MessageBox.Show("+" + satır + " Hemsire Kaydı basarıyla eklendi:)");
        ...
        private void HemsireEkle_Load(object sender, EventArgs e)
        {
